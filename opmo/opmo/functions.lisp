...
;;;(interval-to-integer '(2 2 1 2) :start 60)
;;; (60 58 56 55 53) !!! THE LIMIT IS 60
...
;;; OM: (gen-divide '(2 3 4) '(1 2 3 4 5 6 7 8 9))
...
(defmacro bao (arith val1 val2)
    "Basic Arithmetic Operations (BAO). Both arguments can be numbers or lists."
`(let* ((va1 (if (numberp ,val1) (list ,val1) ,val1))
       (va2 (if (numberp ,val2) (list ,val2) ,val2))
       (v1 (if (numberp ,val1) (loop repeat (length va2) collect ,val1) va1))
       (v2 (if (numberp ,val2) (loop repeat (length va1) collect ,val2) va2)))
...
;;; OM: (gen-repeat 3 '(1 2 3 4))
;;; OM: (gen-repeat-seq 11 1 1 '(1 2 3 4))
